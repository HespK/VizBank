...
!(function (e) {
  ...
  function t(t, r) {
    ...
    return (
      ...
      ((e.File && t instanceof File) || t instanceof Object) &&
      (o = new s(r)),
      o.stream(t)
    );
  }
  ...
  function r(e, t) {
    ...
    var o = !1,
      ...
      h = "\r\n";
    if (
      (r(), "string" == typeof e && (e = JSON.parse(e)), e instanceof Array)
    ) {
      ...
      return (
        ...
        (e.fields ||
          (e.fields = e.data[0] instanceof Array ? e.fields : n(e.data[0])),
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          return (
            ...
            ((this._completeResults.data = this._completeResults.data.concat(
              ...
              (this._completeResults.meta = i.meta)), !a ||
    ...
    (this._readChunk = function () {
      ...
      if (
        ((r = new XMLHttpRequest()),
          k ||
          ((r.onload = g(this._chunkLoaded, this)),
  ...
  function o(e) {
    ...
    function i() {
      ...
      for (var t = 0; t < b.data.length; t++) {
        for (var r = {}, n = 0; n < b.data[t].length; n++) {
          ...
          e.header &&
            (n >= y.length ?
              (r.__parsed_extra || (r.__parsed_extra = []),
                r.__parsed_extra.push(b.data[t][n])) :
              (r[y[n]] = b.data[t][n]));
        }
        e.header &&
          ((b.data[t] = r),
    ...
    function s(t) {
      for (
        var r, n, i, s = [",", "  ", "|", ";", S.RECORD_SEP, S.UNIT_SEP], a = 0; a < s.length; a++
      ) {
        var o = s[a],
          h = 0,
          f = 0;
  ...
  function u(e) {
    ...
    var t = e.delimiter,
      ...
      a = e.fastMode;
    if (
      (("string" != typeof t || S.BAD_DELIMITERS.indexOf(t) > -1) && (t = ","),
        n === t)
    )
      throw "Comment character same as delimiter";
    n === !0 ?
      (n = "#") :
      ("string" != typeof n || S.BAD_DELIMITERS.indexOf(n) > -1) && (n = !1),
      "\n" != r && "\r" != r && "\r\n" != r && (r = "\n");
    var o = 0,
      u = !1;
    (this.parse = function (e, h, f) {
      ...
      function d(t) {
        return f ?
          p() :
          ("undefined" == typeof t && (t = e.substr(o)),
            w.push(t),
            (o = g),
            c(w),
            y && _(),
      ...
      for (var x = e.indexOf(t, o), O = e.indexOf(r, o);;)
        ...
        if (-1 === O) break;
        if ((w.push(e.substring(o, O)), l(O + v), y && (_(), u)))
          return p();
  ...
  function c(e) {
    ...
    if (t.error) r.userError(t.error, t.file);
      ...
      if (m(r.userStep)) {
        for (
          var a = 0; a < t.results.data.length &&
          (r.userStep({
        ...
        m(r.userChunk) && (r.userChunk(t.results, s, t.file), delete t.results);
    }
        ...
        if (m(t.before)) {
          ...
          if ("object" == typeof r) {
            ...
            "object" == typeof r.config &&
              (e.instanceConfig = C.extend(e.instanceConfig, r.config));
