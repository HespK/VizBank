            ...
            complete: function (results) {
                ...
                $('#customer-submit').click(function (evt) {
                    ...
                    $('#heatmap').highcharts({
                            ...
                            yAxis: {
                                categories: ['12p',"1a", "2a", "3a", "4a", "5a", "6a", "7a", "8a", "9a", "10a", "11a", "12a", "1p", "2p", "3p", "4p", "5p", "6p", "7p", "8p", "9p", "10p", "11p", "12p"],
                                title: null
                            },
                            ...
                            tooltip: {
                                formatter: function () {
                                    return   '<b> On </b>'+'<b>' + this.series.xAxis.categories[this.point.x] + "<br />" + 
                                             this.point.value + '</b> visits on <br><b>' + this.series.yAxis.categories[this.point.y] + '</b>';
                                }
                            },
                    ...
                    //Column chart
                    var valuesVisitsDay=Object.keys(dataVisCustomerHistory[1]).map(function(key){
                    ...
                    //Bar chart
                    var valuesVisitsHour=Object.keys(dataVisCustomerHistory[4]).map(function(key){
                    ...
                    $('#totalVisits').html("Total Number of Visits: "+ dataVisCustomerHistory[3]);
                ...
                $('#branch-submit').click(function (evt) {
                    ...
                    //Column chart
                    var valuesVisitsDay=Object.keys(dataVisBranchHistory[1]).map(function(key){
                    ...
                    //Bar chart
                    var valuesVisitsHour=Object.keys(dataVisBranchHistory[4]).map(function(key){
                    ...
                    var branchTable = new Array();
                        ...
                        dvTable.innerHTML = "";
                        dvTable.appendChild(table);
                    $('#totalVisits').html("Total Number of Visits: "+ dataVisBranchHistory[3]);
...
var visMap = function (){
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/hespk/ciqnh5ctv0007sbnp19mrtaec/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaGVzcGsiLCJhIjoiY2lxbXphaDhtMDB6OGZwbm44ODZiN3ZxZiJ9.Ik94chI0325GS3pGGvZQsg', {
